...
std::unordered_map<int, std::unordered_map<std::wstring, std::unique_ptr<EventParams>>> MapStatic::eventParams = [] 
	...
	tempEventParams[0].emplace(L"Monster009", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 0 }, 0));
	tempEventParams[0].emplace(L"Monster010", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 1 }, 0));
	tempEventParams[0].emplace(L"Monster011", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 2 }, 0));
	tempEventParams[0].emplace(L"Monster012", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 3 }, 0));
	tempEventParams[0].emplace(L"Monster013", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 4 }, 0));
	tempEventParams[0].emplace(L"Monster014", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 5 }, 0));
	tempEventParams[0].emplace(L"Monster015", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 6 }, 0));
	tempEventParams[0].emplace(L"Monster016", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 7 }, 0));
	tempEventParams[0].emplace(L"Monster017", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 8 }, 0));
	tempEventParams[0].emplace(L"Monster018", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 9 }, 0));
	tempEventParams[0].emplace(L"Monster019", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 10 }, 0));
	tempEventParams[0].emplace(L"Monster021", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 1, 11 }, 0));
	tempEventParams[0].emplace(L"Monster022", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 2, 2 }, 0));
	tempEventParams[0].emplace(L"Monster023", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 2, 3 }, 0));
	tempEventParams[0].emplace(L"Monster024", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 2, 4 }, 0));
	tempEventParams[0].emplace(L"Monster025", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 2, 5 }, 0));
	tempEventParams[0].emplace(L"Monster026", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 2, 6 }, 0));
	tempEventParams[0].emplace(L"Monster027", std::make_unique<MonsterParams>(EventType::MONSTER, Coord{ 2, 7 }, 0));
